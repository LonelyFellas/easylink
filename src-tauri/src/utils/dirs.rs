...
pub static APP_ID: &str = "io.github.lonelyfellas.easylink";
#[cfg(not(feature = "verge-dev"))]
pub static BACKUP_DIR: &str = "easylink-backup";

#[cfg(feature = "verge-dev")]
pub static APP_ID: &str = "io.github.lonelyfellas.easylink.dev";
#[cfg(feature = "verge-dev")]
pub static BACKUP_DIR: &str = "easylink-backup-dev";
